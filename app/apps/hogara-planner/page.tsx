...
export default function PremiumPage() {
  ...
  const handleBasePlanSubscribe = async (planTier: 'basic_7' | 'complete_15') => {
    if (!session?.user) {
      router.push("/auth/login?redirect=/apps/hogara-planner")
      return
    }
        ...
        <section className="relative py-20 bg-gradient-to-br from-hogara-cream via-hogara-pink/10 to-hogara-lavender/10 overflow-hidden">
          ...
          <div className="container relative z-10">
            <div className="max-w-3xl mx-auto text-center space-y-6">
              ...
              {(userStatus.hasBasePlan || userStatus.magicalCompanionsActive || isAdmin) && (
                <div className="flex flex-col items-center gap-4 pt-6">
                  ...
                  <Button
                    onClick={() => router.push('/apps/hogara-planner/dashboard')}
                    size="lg"
